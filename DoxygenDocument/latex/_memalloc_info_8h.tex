...
\label{_memalloc_info_8h}\index{ANSICInformation/MemallocInfo.h@{ANSICInformation/MemallocInfo.h}}
...
\subsubsection[{MEMALLOC\_\-INFO}]{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf memory\_\-allocation\_\-info}  {\bf MEMALLOC\_\-INFO}}\label{_memalloc_info_8h_ac195f09baa3fd86235c8bf9c0c103888}
...
)}\label{_memalloc_info_8h_a6660d813f42687f1cc9f1fecf1f16ef0}
calloc関数に関する情報を取得する 
\begin{DoxyParams}{引数}
{\em root} & \\
\hline
...
\item[{CSTLString $\ast$}]{constant}
\end{DoxyParamCaption}
)}\label{_memalloc_info_8h_a44daa61bf2a56ae7b5a29e7b43dd0e2a}
malloc関数に関する情報を取得する 
\begin{DoxyParams}{引数}
{\em root} & \\
\hline
...
\item[{{\bf AST} $\ast$}]{root}
\end{DoxyParamCaption}
)}\label{_memalloc_info_8h_a0f47635fa5f6ec3f88df9d13f3facc85}
...
\end{DoxyParamCaption}
)}\label{_memalloc_info_8h_adc8171dd663897d8dbaea3d837453242}
...
\item[{VARIABLE\_\-TABLE\_\-LIST $\ast$}]{vtlist}
\end{DoxyParamCaption}
)}\label{_memalloc_info_8h_a1ce27f7b14a1ba76647f0d8dc0cca30e}
...
\end{DoxyParamCaption}
)}\label{_memalloc_info_8h_aed5ea9294b1778c648246294a76b4c6b}
...
\item[{char $\ast$}]{size}
\end{DoxyParamCaption}
)}\label{_memalloc_info_8h_afe34555376d69246b3a082014cad78af}
メモリ割り当てに関する情報を格納するための構造体のデータを生成させる 
\begin{DoxyParams}{引数}
{\em sizeof\_\-type} & sizeofの型名 \\
\hline
...
\item[{{\bf AST} $\ast$}]{root}
\end{DoxyParamCaption}
)}\label{_memalloc_info_8h_a4db917a362836842caf646ada69b38b8}
