...
\label{_declaration_p_s_i_8h}\index{ProgramSlicing/DeclarationPSI.h@{ProgramSlicing/DeclarationPSI.h}}
...
)}\label{_declaration_p_s_i_8h_a84e0b014b44675ec9ba51fe3ed31062f}
宣言式のASTノードdeclarationから、関数に対するプログラムスライシングを抽出し、[ プログラムスライシングリストexpr\_\-slicing\_\-listに追加する。
