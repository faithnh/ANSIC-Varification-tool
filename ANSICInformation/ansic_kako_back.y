...
VARIDATE_VARIABLE_LIST *varidate_variable_list;
VARIDATE_STATEMENT_LIST *varidate_statement_list;
INCLUDE_LIST *include_list;
FOR_INFORMATION_LIST *for_information_list;
...
primary_expression
	...
	| CONSTANT				{$$ = $1;}
	| STRING_LITERAL		{$$ = $1;}
	| '(' expression ')'	{$$ = new_AST("primary_expression","",line); multi_push_back_childrenAST($$, 3, $1, $2, $3);}
	;

postfix_expression
	: primary_expression												{
																			$$ = new_AST("postfix_expression", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| postfix_expression '[' array_content ']'							{
																			$$ = new_AST("array_access", "", line);
																			multi_push_back_childrenAST($$, 4, $1, $2, $3, $4);
																		}
	| postfix_expression '(' ')'										{
																			$$ = new_AST("call_function", "", line);
	...
	| postfix_expression '.' IDENTIFIER									{
																			$$ = new_AST("struct_access", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| postfix_expression PTR_OP IDENTIFIER								{
																			$$ = new_AST("p_struct_access", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| postfix_expression INC_OP											{
																			$$ = new_AST("inc_after_expr", "", line);
																			multi_push_back_childrenAST($$, 2, $1, $2);
																		}
	| postfix_expression DEC_OP											{
																			$$ = new_AST("dec_after_expr", "", line);
																			multi_push_back_childrenAST($$, 2, $1, $2);
																		}
...
argument_expression_list
	: argument_expression												{
																			$$ = new_AST("argument_expression_list", "", line);
																			push_back_childrenAST($$, $1);
																		}
...
argument_expression
	: conditional_expression											{
																			$$ = new_AST("t_argument_expression", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| unary_expression assignment_operator argument_expression			{
																			$$ = new_AST("argument_expression", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	;
...
unary_expression
	: postfix_expression												{
																			$$ = new_AST("unary_expression", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| INC_OP unary_expression											{
																			$$ = new_AST("inc_expr","",line);
																			multi_push_back_childrenAST($$, 2, $1, $2);
																		}
	| DEC_OP unary_expression											{
																			$$ = new_AST("dec_expr","",line);
																			multi_push_back_childrenAST($$, 2, $1, $2);
																		}
	| '&' cast_expression												{
																			$$ = new_AST("address_ref","",line);
																			multi_push_back_childrenAST($$, 2, $1, $2);
																		}
	| '*' cast_expression												{
																			$$ = new_AST("direct_ref","",line);
																			multi_push_back_childrenAST($$, 2, $1, $2);
																		}
	| '+' cast_expression												{
																			$$ = new_AST("plus_op","",line);
																			multi_push_back_childrenAST($$, 2, $1, $2);
																		}
	| '-' cast_expression												{
																			$$ = new_AST("minus_op","",line);
																			multi_push_back_childrenAST($$, 2, $1, $2);
																		}
	| '~' cast_expression												{
																			$$ = new_AST("xor_op","",line);
	...
	| SIZEOF unary_expression											{
																			$$ = new_AST("sizeof_expression","",line);
																			multi_push_back_childrenAST($$, 2, $1, $2);
																		}
	| SIZEOF '(' type_name ')'											{
																			$$ = new_AST("sizeof_expression","",line);
...
cast_expression
	: unary_expression													{
																			$$ = new_AST("t_cast_expression", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| '(' type_name ')' cast_expression									{
																			$$ = new_AST("cast_expression", "", line);
																			multi_push_back_childrenAST($$, 4, $1, $2, $3, $4);
																		}
	;
...
all_expression
	: all_expression OR_OP all_expression								{
																			$$ = new_AST("log_or_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}

	| all_expression AND_OP all_expression								{
																			$$ = new_AST("log_and_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression '|' all_expression									{
																			$$ = new_AST("or_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression '^' all_expression									{
																			$$ = new_AST("xor_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression '&' all_expression									{
																			$$ = new_AST("and_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression EQ_OP all_expression								{
																			$$ = new_AST("eq_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression NE_OP all_expression								{
																			$$ = new_AST("ne_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression '<' all_expression									{
																			$$ = new_AST("lethan_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression '>' all_expression									{
																			$$ = new_AST("gethan_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression LE_OP all_expression								{
																			$$ = new_AST("leeq_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression GE_OP all_expression								{
																			$$ = new_AST("geeq_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression LEFT_OP all_expression								{
																			$$ = new_AST("left_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression RIGHT_OP all_expression							{
																			$$ = new_AST("right_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression '+' all_expression									{
																			$$ = new_AST("plus_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression '-' all_expression									{
																			$$ = new_AST("minus_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression '*' all_expression									{
																			$$ = new_AST("mul_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression '/' all_expression									{
																			$$ = new_AST("div_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| all_expression '%' all_expression									{
																			$$ = new_AST("mod_expr", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	| cast_expression													{
																			$$ = new_AST("t_all_expression", "", line);
																			push_back_childrenAST($$, $1);
																		}
...
conditional_expression
	: all_expression													{
																			$$ = new_AST("t_conditional_expression", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| all_expression '?' expression ':' conditional_expression			{
																			$$ = new_AST("conditional_expression", "", line);
...
assignment_expression
	: conditional_expression											{
																			$$ = new_AST("t_assignment_expression", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| unary_expression assignment_operator assignment_expression		{
																			$$ = new_AST("assignment_expression", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	;
...
expression
	: assignment_expression												{
																			$$ = new_AST("t_expression", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| expression ',' assignment_expression								{
																			$$ = new_AST("expression", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	;
...
constant_expression
	: conditional_expression											{
																			$$ = new_AST("constant_expression", "", line);
																			push_back_childrenAST($$, $1);
																		}
	;
...
declaration
	: declaration_specifiers ';'										{
																			$$ = new_AST("declaration", "", line);
																			multi_push_back_childrenAST($$, 2, $1, $2);
																		}
	| declaration_specifiers init_declarator_list ';'					{
																			$$ = new_AST("declaration_with_init", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
...
declaration_specifiers
	: storage_class_specifier											{
																			$$ = new_AST("storage_class_specifier", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| storage_class_specifier declaration_specifiers					{
																			$$ = new_AST("declaration_specifiers", "", line);
																			multi_push_back_childrenAST($$, 2, $1, $2);
																		}
	| type_specifier													{
																			$$ = new_AST("type_specifier", "", line);
																			push_back_childrenAST($$, $1);
																		}
	...
	| function_specifier												{
																			$$ = new_AST("function_specifier", "", line);
																			push_back_childrenAST($$, $1);
																		}
...
init_declarator_list
	: init_declarator													{
																			$$ = new_AST("t_init_declarator_list", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| init_declarator_list ',' init_declarator							{
																			$$ = new_AST("init_declarator_list", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	;
...
init_declarator
	: declarator														{
																			$$ = new_AST("t_init_declarator", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| declarator '=' initializer										{
																			$$ = new_AST("init_declarator", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	;
...
struct_or_union_specifier
	: struct_or_union IDENTIFIER '{' struct_declaration_list '}'		{
																			$$ = new_AST("struct_or_union_specifier", "", line);
																			multi_push_back_childrenAST($$, 5, $1, $2, $3, $4 ,$5);
																		}
...
struct_declaration_list
	: struct_declaration												{
																			$$ = new_AST("t_struct_declaration_list", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| struct_declaration_list struct_declaration						{
																			$$ = new_AST("struct_declaration_list", "", line);
																			multi_push_back_childrenAST($$, 2, $1, $2);
																		}
	;
...
struct_declaration
	: specifier_qualifier_list struct_declarator_list ';'				{
																			$$ = new_AST("struct_declaration", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	;
...
specifier_qualifier_list
	: type_specifier specifier_qualifier_list							{
																			$$ = new_AST("specifier_qualifier_list", "", line);
																			multi_push_back_childrenAST($$, 2, $1, $2);
																		}
	| type_specifier													{
																			$$ = new_AST("type_specifier", "", line);
...
struct_declarator_list
	: struct_declarator													{
																			$$ = new_AST("t_struct_declarator_list", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| struct_declarator_list ',' struct_declarator						{
																			$$ = new_AST("struct_declarator_list", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	;
...
struct_declarator
	: declarator														{
																			$$ = new_AST("struct_declarator", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| ':' constant_expression											{
																			$$ = new_AST("struct_declarator_list", "", line);
...
enumerator_list
	: enumerator														{
																			$$ = new_AST("t_enumerator_list", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| enumerator_list ',' enumerator									{
																			$$ = new_AST("enumerator_list", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	;
...
enumerator
	: IDENTIFIER														{
																			$$ = new_AST("enumerator", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| IDENTIFIER '=' constant_expression								{
																			$$ = new_AST("enumerator_assign", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	;
...
direct_declarator
	: IDENTIFIER																	{
																						$$ = new_AST("direct_declarator", "", line);
																						push_back_childrenAST($$, $1);
																					}
	| '(' declarator ')'															{
																						$$ = new_AST("direct_declarator", "", line);
	...
	| direct_declarator '[' type_qualifier_list assignment_expression ']'			{
																						$$ = new_AST("direct_declarator_array", "", line);
																						multi_push_back_childrenAST($$, 5, $1, $2, $3, $4, $5);
																					}
	...
	| direct_declarator '(' parameter_type_list ')'									{
																						$$ = new_AST("direct_declarator_function", "", line);
																						multi_push_back_childrenAST($$, 4, $1, $2, $3, $4);
																					}
...
type_qualifier_list
	...
	| type_qualifier_list type_qualifier											{
																						$$ = new_AST("type_qualifier_list", "", line);
																						multi_push_back_childrenAST($$, 2, $1, $2);
																					}
	;
...
parameter_type_list
	: parameter_list																{
																						$$ = new_AST("parameter_type_list", "", line);
																						push_back_childrenAST($$, $1);
																					}
...
parameter_list
	: parameter_declaration															{
																						$$ = new_AST("t_parameter_list", "", line);
																						push_back_childrenAST($$, $1);
																					}
	| parameter_list ',' parameter_declaration										{
																						$$ = new_AST("parameter_list", "", line);
																						multi_push_back_childrenAST($$, 3, $1, $2, $3);
																					}
	;
...
parameter_declaration
	: declaration_specifiers declarator												{
																						$$ = new_AST("parameter_declaration_with_declarator", "", line);
																						multi_push_back_childrenAST($$, 2, $1, $2);
																					}
	| declaration_specifiers abstract_declarator									{
																						$$ = new_AST("parameter_declaration", "", line);
																						multi_push_back_childrenAST($$, 2, $1, $2);
																					}
	| declaration_specifiers														{
																						$$ = new_AST("parameter_declaration", "", line);
...
identifier_list
	: IDENTIFIER																	{
																						$$ = new_AST("t_identifier_list", "", line);
																						push_back_childrenAST($$, $1);
																					}
	| identifier_list ',' IDENTIFIER												{
																						$$ = new_AST("identifier_list", "", line);
																						multi_push_back_childrenAST($$, 3, $1, $2, $3);
																					}
	;
...
abstract_declarator
	: pointer																		{
																						$$ = new_AST("abstract_declarator", "", line);
																						push_back_childrenAST($$, $1);
																					}
...
direct_abstract_declarator
	: '(' abstract_declarator ')'													{
																						$$ = new_AST("direct_abstract_declarator", "", line);
																						multi_push_back_childrenAST($$, 3, $1, $2, $3);
																					}
	| '[' ']'																		{
																						$$ = new_AST("direct_abstract_declarator_array", "", line);
																						multi_push_back_childrenAST($$, 2, $1, $2);
																					}
	| '[' assignment_expression ']'													{
																						$$ = new_AST("direct_abstract_declarator_array", "", line);
	...
	| direct_abstract_declarator '(' ')'											{
																						$$ = new_AST("direct_abstract_declarator_function", "", line);
																						multi_push_back_childrenAST($$, 3, $1, $2, $3);
																					}
...
initializer_list
	: initializer																	{
																						$$ = new_AST("t_initializer_list", "", line);
																						push_back_childrenAST($$, $1);
																					}
...
designator_list
	: designator																	{
																						$$ = new_AST("t_designator_list", "", line);
																						push_back_childrenAST($$, $1);
																					}
	| designator_list designator													{
																						$$ = new_AST("designator_list", "", line);
																						multi_push_back_childrenAST($$, 2, $1, $2);
																					}
	;
...
labeled_statement
	: IDENTIFIER ':' statement														{
																						$$ = new_AST("goto_labeled_statement", "", line);
																						multi_push_back_childrenAST($$, 3, $1, $2, $3);
																					}
	| CASE constant_expression ':' statement										{
																						$$ = new_AST("case_labeled_statement", "", line);
																						multi_push_back_childrenAST($$, 4, $1, $2, $3, $4);
																					}
	| DEFAULT ':' statement															{
																						$$ = new_AST("default_labeled_statement", "", line);
																						multi_push_back_childrenAST($$, 3, $1, $2, $3);
																					}
	;
...
compound_statement
	: '{' '}'																		{
																						$$ = new_AST("compound_statement_a", "", line);
																						multi_push_back_childrenAST($$, 2, $1, $2);
																					}
	| '{' block_item_list '}'														{
																						$$ = new_AST("compound_statement_b", "", line);
																						multi_push_back_childrenAST($$, 3, $1, $2, $3);
																					}
	;
...
block_item_list
	: block_item																	{
																						$$ = new_AST("t_block_item_list", "", line);
																						push_back_childrenAST($$, $1);
																					}
	| block_item_list block_item													{
																						$$ = new_AST("block_item_list", "", line);
																						multi_push_back_childrenAST($$, 2, $1, $2);
																					}
	;
...
expression_statement
	: ';'																			{
																						$$ = new_AST("expression_statement", "", line);
																						push_back_childrenAST($$, $1);
																					}
	| expression ';'																{
																						$$ = new_AST("expression_statement", "", line);
...
selection_statement
	: IF '(' expression ')' statement												{
																						$$ = new_AST("if_statement", "", line);
																						multi_push_back_childrenAST($$, 5, $1, $2, $3, $4, $5);
																					}
	| IF '(' expression ')' statement ELSE statement								{
																						$$ = new_AST("ifelse_statement", "", line);
																						multi_push_back_childrenAST($$, 7, $1, $2, $3, $4, $5, $6, $7);
																					}
	| SWITCH '(' expression ')' statement											{
																						$$ = new_AST("switch_statement", "", line);
																						multi_push_back_childrenAST($$, 5, $1, $2, $3, $4, $5);
																					}
	;
...
do_while_expression
	: assignment_expression												{
																			$$ = new_AST("t_do_while_expression", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| expression ',' assignment_expression								{
																			$$ = new_AST("do_while_expression", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	;
...
while_expression
	: assignment_expression												{
																			$$ = new_AST("t_while_expression", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| expression ',' assignment_expression								{
																			$$ = new_AST("while_expression", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	;
...
for_expression
	: assignment_expression												{
																			$$ = new_AST("t_for_expression", "", line);
																			push_back_childrenAST($$, $1);
																		}
	| expression ',' assignment_expression								{
																			$$ = new_AST("for_expression", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																		}
	;
...
for_expression_statement
	: ';'																			{
																						$$ = new_AST("for_expression_statement", "", line);
																						push_back_childrenAST($$, $1);
																					}
	| expression ';'																{
																						$$ = new_AST("for_expression_statement", "", line);
...
for_declaration
	: declaration_specifiers ';'										{
																			$$ = new_AST("for_declaration", "", line);
																			multi_push_back_childrenAST($$, 2, $1, $2);
																		}
	| declaration_specifiers init_declarator_list ';'					{
																			$$ = new_AST("for_declaration_with_init", "", line);
																			multi_push_back_childrenAST($$, 3, $1, $2, $3);
																			//TYPEDEFテーブルリストに登録させる
																			getTYPEDEF_TABLE_DATA(typedef_table_list, $1, $2);
																		}
...
jump_statement
	: GOTO IDENTIFIER ';'															{
																						$$ = new_AST("goto_statement", "", line);
																						multi_push_back_childrenAST($$, 3, $1,$2, $3);
																					}
	| CONTINUE ';'																	{
																						$$ = new_AST("continue_statement", "", line);
																						multi_push_back_childrenAST($$, 2, $1, $2);
																					}
	| BREAK ';'																		{
																						$$ = new_AST("break_statement", "", line);
																						multi_push_back_childrenAST($$, 2, $1, $2);
																					}
	| RETURN ';'																	{
																						$$ = new_AST("return_statement", "", line);
																						multi_push_back_childrenAST($$, 2, $1, $2);
																					}
	| RETURN expression ';'															{
																						$$ = new_AST("return_expr_statement", "", line);
																						multi_push_back_childrenAST($$, 3, $1,$2, $3);
																					}
	;
program
	: translation_unit																{
																						$$ = new_AST("program", "", line);
																						push_back_childrenAST($$, $1);
																						programAST = $$;
...
translation_unit
	: external_declaration															{
																						$$ = new_AST("t_translation_unit", "", line);
																						push_back_childrenAST($$, $1);
																					}
	| translation_unit external_declaration											{
																						$$ = new_AST("translation_unit", "", line);
																						multi_push_back_childrenAST($$, 2, $1, $2);
																					}
	;
...
external_declaration
	: function_definition															{
																						$$ = new_AST("external_declaration", "", line);
																						push_back_childrenAST($$, $1);
																					}
	| declaration																	{
																						$$ = new_AST("external_declaration", "", line);
...
function_definition
	: declaration_specifiers declarator declaration_list compound_statement			{
																						$$ = new_AST("function_definition_type_a", "", line);
																						multi_push_back_childrenAST($$, 4, $1, $2, $3, $4);
																					}
	| declaration_specifiers declarator compound_statement							{
																						$$ = new_AST("function_definition_type_b", "", line);
																						multi_push_back_childrenAST($$, 3, $1, $2, $3);
																					}
	;
...
declaration_list
	: declaration																	{
																						$$ = new_AST("t_declaration_list", "", line);
																						push_back_childrenAST($$, $1);
																					}
	| declaration_list declaration													{
																						$$ = new_AST("declaration_list", "", line);
																						multi_push_back_childrenAST($$, 2, $1, $2);
																					}
	;
